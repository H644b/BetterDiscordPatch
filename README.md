# BetterDiscordPatch
An efficient program which lets you install BetterDiscord without user interaction and (optionally) patches BetterDiscord whenever Discord updates.</br>
BetterDiscord doesn't automatically patch itself when Discord updates, so BetterDiscordPatch offers a fix for that.

## Features
- BetterDiscordPatch.app / betterdiscordpatch.exe can patch BetterDiscord without any user interaction, unlike the official installer
    ...
    - **You can disable the auto-patch functionality in the installer while still being able to install BetterDiscord without a UI.**
- Patch BetterDiscord automatically, even through Discord updates
...
Run install_[YOUR OPERATING SYSTEM].py to install BetterDiscordPatch from source.</br>
...
Copyright (c) 2017 BetterDiscord and BetterDiscord Installer contributors</br>
